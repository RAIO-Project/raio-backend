...
import raio.common.marker.TypeSafeMarker;
import raio.common.marker.TypeSafeMarker.Missing;
import raio.common.marker.TypeSafeMarker.Present;

import java.util.Collection;

import static raio.common.status.exception.StatusCodeErrorCode.CATEGORY_BITS_OVERFLOW;
import static raio.common.status.exception.StatusCodeErrorCode.INSTANCE_DETAIL_BITS_OVERFLOW;
import static raio.common.status.exception.StatusCodeErrorCode.SYS_INFO_OVERFLOW;
