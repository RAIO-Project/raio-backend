...
import raio.common.validation.model.interfaces.DurationBoundedValidationProperty;
import raio.common.validation.model.interfaces.DurationValidationSpec;
import raio.common.validation.model.interfaces.SteppedDateTimeValidationProperty;

import java.util.HashMap;
import java.util.List;
import java.util.Map;

import static raio.common.validation.model.interfaces.BaseValidationProperty.ReservedFieldNames.MAX_DURATION;
import static raio.common.validation.model.interfaces.BaseValidationProperty.ReservedFieldNames.MIN_DURATION;
