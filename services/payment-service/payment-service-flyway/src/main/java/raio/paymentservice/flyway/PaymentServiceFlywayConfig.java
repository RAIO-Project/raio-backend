...
@Configuration
@EnableConfigurationProperties(PaymentServiceFlywayProperties.class)
public class PaymentServiceFlywayConfig {
    
    @Bean(initMethod = "migrate")
    public Flyway paymentFlyway(DataSource dataSource, PaymentServiceFlywayProperties props) {
