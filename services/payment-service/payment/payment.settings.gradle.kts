...
val paymentGrpcClientAdapter: String by settings
...
val paymentDirectory = getDirectories("services/payment-service", "payment")
...
project(paymentGrpcClientAdapter).projectDir = paymentDirectory("grpc-client")