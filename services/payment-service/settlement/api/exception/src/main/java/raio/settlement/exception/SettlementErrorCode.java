package raio.settlement.exception;
...
public enum SettlementErrorCode implements ErrorCode {
    ...
    SettlementErrorCode(String message, HttpStatus httpStatus) {
    ...
    @Override
    public SettlementException exception() {
        return new SettlementException(this);
    }

    @Override
    public SettlementException exception(Throwable cause) {
        return new SettlementException(this, cause);
    }

    @Override
    public RuntimeException exception(Runnable runnable) {
        return new SettlementException(this, runnable);
    }

    @Override
    public RuntimeException exception(Runnable runnable, Throwable cause) {
        return new SettlementException(this, runnable, cause);
    }

    @Override
    public RuntimeException exception(Supplier<Map<String, Object>> payload) {
        return new SettlementException(this, payload);
    }

    @Override
    public RuntimeException exception(Supplier<Map<String, Object>> payload, Throwable cause) {
        return new SettlementException(this, payload, cause);
    }
}