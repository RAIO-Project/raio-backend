package raio.payment.payment.application.service
...
import raio.payment.payment.application.readmodel.PaymentReadModels.PaymentConfirmResult
import raio.payment.payment.application.command.PaymentCommands.ConfirmCommand
import raio.payment.payment.application.command.PaymentCommands.PrepareCommand
import raio.payment.payment.application.port.PaymentClientPort
import raio.payment.payment.application.port.PaymentCommandRepositoryPort
import raio.payment.wallet.application.usecase.PointChargeUseCase
import raio.payment.wallet.application.usecase.WalletReadUseCase
import raio.payment.payment.domain.Payment
import raio.payment.wallet.domain.Wallet
import raio.payment.payment.domain.type.PaymentMethod
import raio.payment.payment.domain.type.PaymentStatus
import raio.payment.payment.domain.type.PgProvider
