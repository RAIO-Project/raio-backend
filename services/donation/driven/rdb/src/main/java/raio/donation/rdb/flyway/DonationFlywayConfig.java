...
@Configuration
@EnableConfigurationProperties(DonationFlywayProperties.class)
public class DonationFlywayConfig {
    
    @Bean(initMethod = "migrate")
    public Flyway donationFlyway(DataSource dataSource, DonationFlywayProperties props) {
