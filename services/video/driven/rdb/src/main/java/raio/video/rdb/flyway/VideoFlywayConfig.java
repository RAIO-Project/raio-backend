...
@Configuration
@EnableConfigurationProperties(VideoFlywayProperties.class)
public class VideoFlywayConfig {

    @Bean(initMethod = "migrate")
    public Flyway videoFlyway(DataSource dataSource, VideoFlywayProperties props) {
