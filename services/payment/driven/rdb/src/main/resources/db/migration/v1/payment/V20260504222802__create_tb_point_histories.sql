...
COMMENT ON COLUMN "payment"."point_histories"."history_id"        IS '원장 식별자';
...
ALTER TABLE "payment"."point_histories" ADD CONSTRAINT "pk_point_histories" PRIMARY KEY ("history_id");
