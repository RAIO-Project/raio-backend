...
public class WalletCommandService implements WalletCreateUseCase, PointChargeUseCase, PointRefundUseCase {
    ...
    public Wallet charge(String walletId, Long amount) {
        ...
        var chargedWallet = walletCommandRepositoryPort.increaseBalance(walletId, amount)
    ...
    public Wallet refund(String walletId, Long amount) {
        ...
        var refundedWallet = walletCommandRepositoryPort.decreaseBalance(walletId, amount)
                .orElseThrow(INSUFFICIENT_POINT_BALANCE::exception);
