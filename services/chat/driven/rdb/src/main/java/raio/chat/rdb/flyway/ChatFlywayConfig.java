...
@Configuration
@EnableConfigurationProperties(ChatFlywayProperties.class)
public class ChatFlywayConfig {
    
    @Bean(initMethod = "migrate")
    public Flyway chatFlyway(DataSource dataSource, ChatFlywayProperties props) {
